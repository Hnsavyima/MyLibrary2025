...
public class ArtistController {
    ...
    @PostMapping("/artists/{id}/affiliate")
    @PreAuthorize("hasRole('ADMIN')")
    public String affiliate(@PathVariable long id,
            @RequestParam(required = false) String troupeId,
        ...
        if (troupeId != null && !troupeId.isEmpty()) {
            Troupe troupe = troupeService.getTroupe(Long.parseLong(troupeId));
        ...
        service.updateArtist(id, artist);
        redirAttrs.addFlashAttribute("successMessage", "Affiliation mise à jour avec succès.");
