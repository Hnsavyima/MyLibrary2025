...
import be.iccbxl.poo.entities.Language;
import be.iccbxl.poo.entities.MyLibrary;
import be.iccbxl.poo.entities.NotAvailableException;
import be.iccbxl.poo.entities.Person;
import be.iccbxl.poo.entities.RangeException;
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            switch (choix) {
                ...
                case 3:
                     ...
                     try {
                        person.borrows(book);
                         ...
                         System.out.println("Le livre sélectionné n'est pas disponible..");
                     }
                     case 4 :
                ...
                case 6:
                    ...
                    //TODO Gestion des cas d'erreur2
                default:
